...
class PositionControl:
    ...
    def __init__(self):
        ...
        file_name = rospy.get_param('~filename', 'WindTurbineControl.yaml')
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # OVERRIDE y controller. This is going to be only roll
            vy_output = self.pos_sp.y
            ...
            temp_euler_ref.x = vy_output
            temp_euler_ref.y = vx_output
...
if __name__ == '__main__':
    ...
    rospy.init_node('wind_turbine_inspection_controller')
