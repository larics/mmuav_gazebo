...
from mmuav_control.cfg import VpcMmuavZCtlParamsConfig
...
class HeightControl:
    ...
    def __init__(self):
        ...
        self.cfg_server = Server(VpcMmuavZCtlParamsConfig, self.cfg_callback)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.t_old = t
            #                              (m_uav + m_arms)/(C*4)
            self.mot_speed_hover = math.sqrt(9.81*(2.083+0.308*4)/(8.54858e-06*4.0))
...
if __name__ == '__main__':
    ...
    rospy.init_node('vpc_rotorsuav_z_controller')
