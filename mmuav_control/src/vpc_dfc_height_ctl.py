...
from mmuav_control.cfg import VpcTtcuavZCtlParamsConfig
...
class HeightControl:
    ...
    def __init__(self):
        ...
        self.cfg_server = Server(VpcTtcuavZCtlParamsConfig, self.cfg_callback)
...
if __name__ == '__main__':
    ...
    rospy.init_node('vpc_ttcuav_z_controller')
