...
class MergeControllerOutputs:
    ...
    def __init__(self):
        ...
        self.payload_position_pub = rospy.Publisher('payload_position', Point, queue_size=1)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Publish payload
            payload_msg = Point()
            payload_msg.x = self.pitch_command
            payload_msg.y = - self.roll_command
...
if __name__ == "__main__":
    rospy.init_node('vpc_mmuav_merge_controller_outputs')
