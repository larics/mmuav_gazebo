...
class MergeControllerOutputs:
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            mot1 = self.mot_vel_ref + self.yaw_command
            mot2 = self.mot_vel_ref - self.yaw_command
            mot3 = self.mot_vel_ref + self.yaw_command
            mot4 = self.mot_vel_ref - self.yaw_command
