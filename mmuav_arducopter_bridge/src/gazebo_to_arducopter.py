...
class StepperInterface():
	def __init__(self):
		...
		rospy.Subscriber('/arducopter/movable_mass_0_position_controller/command', Float64, self.mm1)
		rospy.Subscriber('/arducopter/movable_mass_1_position_controller/command', Float64, self.mm2)
		rospy.Subscriber('/arducopter/movable_mass_2_position_controller/command', Float64, self.mm3)
		rospy.Subscriber('/arducopter/movable_mass_3_position_controller/command', Float64, self.mm4)
